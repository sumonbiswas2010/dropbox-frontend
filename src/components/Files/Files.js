        ...
        >
            ...
            {numSelected > 0 ? (
                <Tooltip title="Delete">
                    <IconButton onClick={props.deleteFiles}>
                        <DeleteIcon />
                    </IconButton>
                </Tooltip>
            ) : (
...
export default function EnhancedTable({ data, setPreviewFile, setIsLoading }) {
    ...
    return (
        <Box sx={{ width: '100%' }}>
            <Paper sx={{ width: '100%', mb: 2 }}>
                <EnhancedTableToolbar deleteFiles={deleteFiles} numSelected={selected.length} />
                <TableContainer>
                    <Table
                        sx={{ minWidth: 750 }}
                                ...
                                .map((row, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell align="right">{row.typeImg}</TableCell>
                                                ...
                                                <Tooltip title="Add To Star">
                                                    <IconButton>
                                                        <Stack spacing={1}>
                                                            <Rating
                                                                name="half-rating"
                                                                defaultValue={row.isStarred ? 1 : 0}
                                                                max={1}
                                                                precision={1}
                                                                onChange={(e, val) =>
                                                                    changeStar(row.key, val)
                                                                }
                                                            />
                                                        </Stack>
                                                    </IconButton>
